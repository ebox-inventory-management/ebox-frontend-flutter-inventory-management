...
List<Brands> brandsListFromJson(String val) => List<Brands>.from(
    json.decode(val)['brands'].map((data) => Brands.fromJson(data)));
...
class Brands {
  ...
  factory Brands.fromJson(Map<dynamic, dynamic> data) => Brands(
        id: data['id'],
