...
CompoundProduct compoundProductListFromJson(String val) =>
    CompoundProduct.fromJson(json.decode(val)['compound']);

class CompoundProduct {
  final int id;
  final String name;
  final int price;
  ...
  factory CompoundProduct.fromJson(Map<dynamic, dynamic> data) =>
      CompoundProduct(
        id: data['id'] ?? 'Not Yet',
        ...
        product_url: List<String>.from(
            data['products'].map((data) => data['product_url'] ?? 'Not Yet')),
