...
class CustomerEdit extends StatefulWidget {
  ...
  const CustomerEdit({super.key, required this.customers});
...
class _CustomerEditState extends State<CustomerEdit> {
  ...
  void initState() {
    super.initState();
    addressController.text = widget.customers.address;
    bankNameController.text = widget.customers.bank_name;
    bankNumberController.text = widget.customers.bank_number;
    cityController.text = widget.customers.city;
    emailController.text = widget.customers.email;
    nameController.text = widget.customers.name;
    phoneController.text = widget.customers.phone;
    shopNameController.text = widget.customers.shop_name;
  }
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  hintText: widget.customers.phone,
                                  hintStyle: TextStyle(fontSize: 16.sp),
                                  border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(10.0.r),
                                  ),
                      ...
                      onPressed: () {
                        if (bankNameController.text.isEmpty ||
                          ...
                          Get.snackbar('Something wrong!',
                              'You need to input all customer information to update',
